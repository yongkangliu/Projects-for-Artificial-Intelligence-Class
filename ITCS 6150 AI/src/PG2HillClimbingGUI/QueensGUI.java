...
public class QueensGUI extends JFrame {
    ...
    public QueensGUI() {
        ...
        QueensGUI.textArea
                .append("--      Hill Climbing algorithm solves 30 Queens problem in 10 seconds (CPU 2.00 GHz).\r\n");
        QueensGUI.textArea
                .append("--      Min-Conflicts algorithm solves 200 Queens problem in 10 seconds (CPU 2.00 GHz).\r\n");
        QueensGUI.textArea
